...
st.caption("Machine Learning + Cloud AI (Hugging Face)")
...
if st.button("🔍 Predict Performance"):
    ...
    prompt = f"""
A student's academic performance is predicted as "{label}".
...
Explain the performance simply and give 3 improvement suggestions.
"""
